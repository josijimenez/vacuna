...
class PersonaController extends AppBaseController
{
    ...
    public function store(CreatePersonaRequest $request)
    {
        ...
        $messages = [
            'cedula.required' => 'Campo Cédula, es requerido!',
            ...
            'telefono.required' => 'Campo Teléfono, es requerido!',
    ...
    public function excel_puesto_vacunacion(Request $request){
        ...
        if (empty($user->puesto_vacunacion)) {
            Flash::error('Usuario no tiene asignado un puesto de Puesto de vacunación, contacte al administrador!!!');
            return redirect(route('informe_puesto_vacunacion'));
        }
